...
# HTML главная страница с выбором типа
HTML_MAIN = '''
<!DOCTYPE html>
<html lang="ru">
<head>
...
QR_TYPES = {
    'url': {
        ...
        'helper': 'Введите любой URL или текст'
    },
    'telegram': {
        'name': 'Telegram',
        'icon': '✈️',
    ...
    'whatsapp': {
        ...
        'helper': 'С кодом страны, например: +79991234567'
    },
    'instagram': {
        'name': 'Instagram',
        'icon': '📷',
    ...
    'facebook': {
        ...
        'placeholder': 'username',
        'helper': 'Введите username или числовой ID профиля'
    },
    'tiktok': {
        'name': 'TikTok',
        'icon': '🎵',
    ...
    'linkedin': {
        ...
        'label': 'Username',
        'placeholder': 'username',
        'helper': 'Введите ваш LinkedIn username из URL профиля'
    },
    'youtube': {
        'name': 'YouTube',
        'icon': '📺',
        ...
        'helper': 'Введите @channel или ID канала'
    },
    'email': {
        'name': 'Email',
        'icon': '📧',
...
def generate_page():
    ...
    return render_template_string(HTML_GENERATE,
                                 type=qr_type,
